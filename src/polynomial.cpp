...
//Default constructor
Polynomial::Polynomial() : poly(nullptr), degree(0)
{
...
Polynomial operator+(const Polynomial& lh, const double rh)
{
    Polynomial newPoly(lh);
    newPoly.poly[0] += rh;
    return newPoly;
}

Polynomial operator+(const double lh, const Polynomial& rh)
{
